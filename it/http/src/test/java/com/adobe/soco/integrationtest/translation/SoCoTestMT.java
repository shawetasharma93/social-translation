...
public class SoCoTestMT extends SoCoMTTranslationBaseIT {

    public SoCoTestMT(final String strTestCaseName, final String strLang, final CommonsITClient clientInstance,
    ...
    public static Collection runtimeParams() throws ClientException, UnsupportedEncodingException {
        ...
        return Arrays
            .asList(new Object[][]{
                ...
                {
                    "TESTCASE: French(FR) comment on PUBLISH instance, PERSISTANCE set as AUTO-PERSIST for ALL LANGUAGES, COMMON STORE set as JAPANESE, Portuguese USER",
                    "fr", commonsAdminPublishClient, "pt-br", langArray, AUTO_PERSIST_ON, "ja"},
                {
                    "TESTCASE: Japanese(JA) comment on PUBLISH instance, PERSISTANCE set as DEFAULT for ALL LANGUAGES,COMMON STORE set as JAPANESE, Portuguese USER",
                    "ja", commonsAdminPublishClient, "pt-br", langArray, PERSIST_DEFAUlT, "ja"},
                {
                    "TESTCASE: German(DE) comment on PUBLISH instance, PERSISTANCE set OFF for ALL LANGUAGES, COMMON STORE set as JAPANESE, Portuguese USER",
                    "de", commonsAdminPublishClient, "pt-br", langArray, AUTO_PERSIST_OFF, "ja"},
