...
@Component
@Service
public class SiteTranslationLanguageCollectionSocialComponentFactory extends AbstractSocialComponentFactory implements
    SocialComponentFactory {

    @Override
    public SocialComponent getSocialComponent(final Resource resource) {
        return new SiteTranslationLanguageCollectionImpl(resource, getClientUtilities(resource.getResourceResolver()));
    }

    @Override
    public SocialComponent getSocialComponent(final Resource resource, final SlingHttpServletRequest request) {
        return new SiteTranslationLanguageCollectionImpl(resource, getClientUtilities(request));
    }
    ...
    public SocialComponent getSocialComponent(final Resource resource, final ClientUtilities clientUtils,
        ...
        return new SiteTranslationLanguageCollectionImpl(resource, clientUtils);
    }

    @Override
    public String getSupportedResourceType() {
        return SiteTranslationLanguageCollection.RESOURCE_TYPE;
    }
